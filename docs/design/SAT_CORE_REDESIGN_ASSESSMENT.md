...
- `last_conflict_is_stale_bound()` suppression sites: **FOUR**, not three — `oxiz-solver/src/solver/theory_manager.rs:616, 1092, 1500, 1654` (§4.4 row 3 cited 616/654/1654). ✔
